/*
  EMSSerial.cpp - Hardware serial library for Wiring
...
// this next line disables the entire EMSSerial.cpp, 
...
#define TXC0 TXC1
#else
#error TXC0 not definable in EMSSerial.h
#endif
#endif
...
#else
  void eMSSerialEvent() __attribute__((weak));
  void eMSSerialEvent() {}
  #define eMSSerialEvent_implemented
...
{
#ifdef eMSSerialEvent_implemented
  if (eMSSerial.available()) eMSSerialEvent();
#endif
...
void EMSSerial::begin(unsigned long baud)
{
...
{
// we do direct write to the UART, for EMS we do not want interrupts for TX
...
// Preinstantiate Objects //////////////////////////////////////////////////////
  ...
  EMSSerial eMSSerial(&UBRRH, &UBRRL, &UCSRA, &UCSRB, &UCSRC, &UDR, RXEN, TXEN, RXCIE);
#elif defined(UBRR0H) && defined(UBRR0L)
  EMSSerial eMSSerial(&UBRR0H, &UBRR0L, &UCSR0A, &UCSR0B, &UCSR0C, &UDR0, RXEN0, TXEN0, RXCIE0);
#elif defined(USBCON)
